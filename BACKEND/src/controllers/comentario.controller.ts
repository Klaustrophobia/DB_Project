...
export const obtenerComentario = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const result = await connection.execute(`SELECT * FROM C##GITHUB.TBL_COMENTARIOS WHERE id_comentario = :id_comentario`, [id_comentario]);
...
export const obtenerComentarios = async (req: Request, res: Response) => {
  ...
  try {
    await connectToDB();
    connection = await oracledb.getConnection();
    const result = await connection.execute(`SELECT * FROM C##GITHUB.TBL_COMENTARIOS ORDER BY id_comentario ASC`);
    await connection.close();
...
export const agregarComentario = async (req: Request, res: Response) => {
  ...
  try {
    ...
    await connection.execute(
      ...
      `INSERT INTO C##GITHUB.TBL_COMENTARIOS 
      (ID_COMENTARIO, ID_USUARIO, FECHA_COMENTARIO, COMENTARIO) 
      VALUES 
      (:ID_COMENTARIO, :ID_USUARIO, TO_DATE(:FECHA_COMENTARIO, 'DD-MON-RR'), :COMENTARIO)`, 
       [ID_COMENTARIO,ID_USUARIO,FECHA_COMENTARIO,COMENTARIO]
      );
...
export const actualizarComentario = async (req: Request, res: Response) => {
  ...
  try {
    ...
    await connection.execute(
      ...
      `UPDATE C##GITHUB.TBL_COMENTARIOS 
      SET 
...
export const eliminarComentario = async (req: Request, res: Response) => {
  ...
  try {
    await connectToDB();
    connection = await oracledb.getConnection();
    await connection.execute(`DELETE FROM C##GITHUB.TBL_COMENTARIOS WHERE id_comentario = :id_comentario`, [id_comentario]);
    await connection.commit();
    await connection.close();
